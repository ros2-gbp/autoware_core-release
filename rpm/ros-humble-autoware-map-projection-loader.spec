...
Name:           ros-humble-autoware-map-projection-loader
Version:        1.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS autoware_map_projection_loader package

License:        Apache License 2.0
URL:            https://index.ros.org/p/autoware_map_projection_loader/#humble
