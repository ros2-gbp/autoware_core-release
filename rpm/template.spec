...
Name:           ros-jazzy-autoware-testing
Version:        1.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS autoware_testing package

License:        Apache 2.0
URL:            https://index.ros.org/p/autoware_testing/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-ros-testing
...
* Fri May 08 2026 Adam Dabrowski <adam.dabrowski@robotec.ai> - 1.8.0-1
- Autogenerated by Bloom
