...
Name:           ros-jazzy-autoware-ground-filter
Version:        1.9.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS autoware_ground_filter package

License:        Apache License 2.0
URL:            https://index.ros.org/p/autoware_ground_filter/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-ament-index-cpp
Requires:       ros-jazzy-autoware-point-types
...
Requires:       ros-jazzy-autoware-utils-tf
...
BuildRequires:  ros-jazzy-autoware-point-types
...
BuildRequires:  ros-jazzy-autoware-utils-tf
...
* Fri May 08 2026 amc-nu <abrahammonrroy@yahoo.com> - 1.8.0-1
- Autogenerated by Bloom
